...
const Create = () => {
  ...
  return (
    ...
    <div className="row">
        <div className="col">
            <h3 className="display-3 text-dark text-center">Create</h3>
        </div>
    </div>
                ...
                <div className="card-body">
                    <form autoComplete="off" onSubmit={submitHandler}>
                        ...
                        <div className="form-group my-3">
                            ...
                            <input type="datetime-local" name='start' id='start' className='form-control' value={task.start} required  onChange={readValue} />
                        </div>

                        <div className="form-group my-3">
                            <label htmlFor="end">Task End Date</label>
                            <input type="datetime-local" name='end' id='end' className='form-control' value={task.end} required  onChange={readValue} />
                        </div>

                        <div className="form-group my-3">
                            <label htmlFor="desc">Description</label>
                            <textarea name='desc' id='desc' cols='30' rows='5' className='form-control' value={task.desc} required  onChange={readValue} />
                        </div>
